# -*- coding: utf-8 -*-
"""projeto_imobiliaria_aula_2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1KB9jPRsS8bLyuIh5q070YCpWjuJ0aZCg
...
df.isnull().sum() #Nome de cada uma das colunas e valores nulos nelas.
...
df.isnull().sum() #Nome de cada uma das colunas e valores nulos nelas.
#repare que agora não temos mais valores nulos.
...
df['Quartos'] == 1
#Onde está True ela possui o valor de 1 quarto
...
#Apenas linhas onde quarto é igual a 1 e valor é menor que 1200

df_1

"""### **2. `Apartamentos` que possuem pelo menos `2 quartos`, `aluguel menor que 3000` e `area maior que 70`**"""

#Podemos fazer isso de maneira junta, da seguinte forma:
...
#Personalizando para ficar melhor
